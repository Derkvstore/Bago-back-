  ...
  try {
    ...
    const updateQuery = `
      ...
      SET client_id = $1, fournisseur_id = $2, marque = $3, modele = $4, stockage = $5, type = $6, type_carton = $7, imei = $8,
          prix_achat_fournisseur = $9, prix_vente_client = $10, montant_paye = $11, montant_restant = $12, statut = $13
      WHERE id = $14 RETURNING *;
    `;
    const result = await clientDb.query(updateQuery, [
        clientId, fournisseurId, marque, modele, stockage, type, type_carton, imei,
        parsedPrixAchatFournisseur, parsedPrixVenteClient, parsedMontantPaye, montantRestant, initialStatut, orderId
    ]);
